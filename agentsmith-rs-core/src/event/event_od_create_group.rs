...
use agentsmith_rs_sys::es_event_od_create_group_t;

use crate::Process;

/// Notification that a group was created.
#[doc(alias = "es_event_od_create_group_t")]
pub struct EventOdCreateGroup<'a> {
    /// The raw reference.
    pub(crate) raw: &'a es_event_od_create_group_t,
