...
use agentsmith_rs_sys::{cpu_subtype_t, cpu_type_t};
use agentsmith_rs_sys::{es_event_exec_t, es_exec_arg, es_exec_arg_count, es_exec_env, es_exec_env_count};
#[cfg(feature = "macos_11_0_0")]
use agentsmith_rs_sys::{es_exec_fd, es_exec_fd_count, es_fd_t, ShouldNotBeNull};
...
unsafe impl Sync for EventExec<'_> {}
