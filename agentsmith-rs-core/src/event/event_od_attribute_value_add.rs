//! [`EventOdAttributeValueAdd`]

use std::ffi::OsStr;

use agentsmith_rs_sys::{es_event_od_attribute_value_add_t, es_od_record_type_t};
...
#[doc(alias = "es_event_od_attribute_value_add_t")]
pub struct EventOdAttributeValueAdd<'a> {
    /// The raw reference.
    pub(crate) raw: &'a es_event_od_attribute_value_add_t,
    /// The version of the message.
    pub(crate) version: u32,
}

impl<'a> EventOdAttributeValueAdd<'a> {
