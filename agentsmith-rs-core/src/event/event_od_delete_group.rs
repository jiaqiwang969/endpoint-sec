...
use agentsmith_rs_sys::es_event_od_delete_group_t;
...
impl_debug_eq_hash_with_functions!(EventOdDeleteGroup<'a> with version; instigator, error_code, group_name, node_name, db_path);
