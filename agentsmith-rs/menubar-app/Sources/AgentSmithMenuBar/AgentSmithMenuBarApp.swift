...
class AppDelegate: NSObject, NSApplicationDelegate, UNUserNotificationCenterDelegate {
    ...
    var viewModel: AgentSmithViewModel?
...
@main
struct AgentSmithMenuBarApp: App {
    @NSApplicationDelegateAdaptor(AppDelegate.self) var appDelegate
    @StateObject private var viewModel = AgentSmithViewModel()
    
    var body: some Scene {
        MenuBarExtra("AgentSmith-RS", systemImage: getIconName()) {
